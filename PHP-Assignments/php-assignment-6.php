...
if(isset($_POST['submitbtn'])){
  ...
  $path="/var/www/html/soumyajithalder.github.io/PHP-Assignments/images/".$file;
  $text=$_POST['text'];
  ...
  echo "<h2>Welcome ".$_REQUEST['first']." ".$_REQUEST['last']."</h2><br><br>";
  echo "<p>First Name: ".$_REQUEST['first']."</p>";
  echo "<p>Last Name: ".$_REQUEST['last']."</p>";
  echo "<p>Full Name: ".$_REQUEST['first']." ".$_REQUEST['last']."</p>";
  echo "<p>Email Address: ".$_REQUEST['email']."</p>";
  echo "<p>Phone No: ".$_REQUEST['phoneno']."</p>";
  echo "<table border='1'>
        <tr>
            <th>Subjects</th>
            <th>Marks</th>
  ...
  $content=ob_get_contents();
    ob_clean();
    file_put_contents(__DIR__."/docs/document.doc",$content);
    echo $content;
  exit;
}
?>
