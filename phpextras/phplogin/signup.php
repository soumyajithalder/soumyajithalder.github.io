<?php
    ...
    $sql="INSERT INTO login (username,password,message) VALUES ('".$username."','".$password."','".$message."')";
   /* echo $password;
    echo $sql;
exit;*/
    session_start();
...
<body>
  ...
  <div id="formContent">
    <form enctype="multipart/form-data" method="post">
      ...
      <input type="text" id="message" class="fadeIn third" name="message" placeholder="Secret Message" required>
